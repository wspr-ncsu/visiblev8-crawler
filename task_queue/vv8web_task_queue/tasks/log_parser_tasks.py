...
from vv8web_task_queue.app.log_parser_app import app
...
def schedule_parse_log_task(log, submission_id, ignore_result=True):
    return parse_log_task.apply_async((log, submission_id), ignore_result=ignore_result)
