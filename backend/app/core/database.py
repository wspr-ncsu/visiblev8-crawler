...
sql_engine = create_engine(f'postgresql+psycopg2://{sql_username}:{sql_password}@{sql_host}:{sql_port}/{sql_database}')
...
mongo_db = mongo_client[os.environ.get('MONGO_DATABASE')]